    ...
    var data = this.state.viewaddress.map((item, index) => {
      ...
      return <div key={index}>
          ...
          <div className="CTAs d-flex justify-content-between flex-column flex-lg-row">
            ...
            <button onClick={()=>{this.update(this.refs)}} className="btn btn-template wide next">Choose delivery method<i className="fa fa-angle-right"></i></button></div>
        </div>
    })
            ...
            <div className="row">
              <div className="col-lg-8">
                <ul className="nav nav-pills">
                  <li className="nav-item"><a  className="nav-link active">Address</a></li>
                  <li className="nav-item"><a className="nav-link disabled">Delivery Method </a></li>
