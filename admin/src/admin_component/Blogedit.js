            ...
            <div className="tile-body">
              <form className="row">
                <div className="form-group col-md-10">
                  ...
                  <input className="form-control" type="text" placeholder="Title product" value="asak mula kopi"/>
                </div>
                <div className="form-group col-md-10">
                  <label className="control-label"> Meta tag tittle </label>
                  <input className="form-control" type="text" placeholder="Meta tag title" value="beginilah ceritanya"/>
                </div>
                <div className="form-group col-md-10">
                  <label className="control-label"> Meta tag Description</label>
                  <input className="form-control" type="text" placeholder="Meta tag description" value="ayuk kita mulai cuy"/>
                </div>
              ...
              <div className="form-group col-md-12">
                ...
                <textarea id="message" rows="3" className="form-control"> Super sekali bung</textarea>
            </div>

                <div className="form-group col-md-4 align-self-end">
                  <button className="btn btn-primary" type="button"><i className="fa fa-fw fa-lg fa-save"></i>Change</button>
                </div>
              </form>
            </div>
          </div>
